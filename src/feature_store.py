...
class RedisFeatureStore:
    ...
    ## This function will use in model training beacuse we need features to train our model
    ...
    ## This function can be used if we want to store features by batches
